...
class JwtService {
    ...
    private val SECRET_KEY: String = "62697631acd9bad6f99074f97f462f7dd95dd6ea1e0a04c9ed3e3ded4134bb5a"
    ...
    fun generateToken(
        ...
        return Jwts.builder()
            ...
            .setIssuedAt(date)
            // 1000 = to secs, 60=to minutes, 60= to hours, 12= 12hours 1000*60*60*12
