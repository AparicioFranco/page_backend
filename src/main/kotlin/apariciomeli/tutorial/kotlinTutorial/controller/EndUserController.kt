...
class EndUserController(private val endUserService: EndUserService) {
  ...
  fun getUsers(): List<CourseAndUsersDTO> {
  ...
  fun getAllUsers(): List<CourseAndUsersDTO> {
    return endUserService.findAllUsers()
  }
