...
class ModuleController(
    ...
    fun getAvailableModulesByCourseId(@PathVariable courseId: Int): List<GroupModulesDTO> {
        return moduleService.getModulesByAvailabilityAndCourseId(courseId).sortedBy { it.groupId }
    }
